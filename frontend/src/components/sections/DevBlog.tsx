...
export function DevBlog() {
  ...
  if (loading) {
    return (
      <section id="devblog" className="py-32 bg-cream">
        <Loading size="lg" />
      </section>
    )
  }

  // Показываем только 3 последних статьи на главной
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {hasMorePosts && (
          ...
          >
            <Link 
              href="/blog"
              className="inline-flex items-center gap-2 px-8 py-4 bg-orange text-white rounded-lg hover:bg-rust transition-all duration-300 font-medium shadow-lg hover:shadow-xl hover:scale-105"
            >
